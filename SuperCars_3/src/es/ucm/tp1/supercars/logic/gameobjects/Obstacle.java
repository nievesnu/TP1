...
public class Obstacle extends GameObject{
	...
	@Override
	public boolean receiveShoot(Player player) { //paso el player para otros obj como pedestrian
		this.onDelete();
		return true;
	}
	
	public boolean receiveExplosion() { //paso el player para otros obj como pedestrian
		this.onDelete();
		return true;
	}
}